This is a simple express app with a boilerplate user system that you can build an app off of. It uses jade templating for the html pages. Feel free to clone it.
